...
public:
  ...
  bool label_cloud(semantic_segmentation::LabelIntegratedPointInstanceCloud::Request  &req,
...
int main(int argc, char **argv){
  ...
  //get some services.
  ros::NodeHandle nh("~");
  ros::ServiceClient client_get_cloud    = nh.serviceClient<semantic_map_publisher::ObservationInstanceService>("/semantic_map_publisher/SemanticMapPublisher/ObservationInstanceService");
