...
namespace libf {
     ...
     */
    template <class T>
    class EfficientEntropyHistogram_t {
    public:
        /**
         * Default constructor. Initializes the histogram with 0 bins.
         */
        EfficientEntropyHistogram_t() :
                bins(0),
                histogram(0),
                mass(0),
                entropies(0),
         ...
         */
        EfficientEntropyHistogram_t(int bins) :
            bins(0),
            histogram(0),
            mass(0),
            entropies(0),
         ...
         */
        EfficientEntropyHistogram_t(const EfficientEntropyHistogram_t & other) :
                bins(0),
                histogram(0),
                mass(0),
                entropies(0),
         ...
         */
        EfficientEntropyHistogram_t & operator= (const EfficientEntropyHistogram_t &other)
        {
    ...
    typedef EfficientEntropyHistogram_t<int> EfficientEntropyHistogram;
