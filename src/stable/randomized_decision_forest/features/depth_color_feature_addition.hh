#ifndef DEPTH_COLORFEATURE_ADDITION_HH
#define DEPTH_COLORFEATURE_ADDITION_HH

#include "tree_feature.hh"

namespace Rdfs {

class DepthColorFeatureAddition : public TreeFeature
{
public:
  DepthColorFeatureAddition(int x1=0, int y1=0, int c1=0, int x2=0, int y2=0, int c2=0);
...
BOOST_CLASS_EXPORT_KEY2(Rdfs::DepthColorFeatureAddition, "DepthColorFeatureAddition")

#endif // DEPTH_COLORFEATURE_ADDITION_HH
