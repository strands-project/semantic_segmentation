#ifndef COLORFEATURE_SUBTRACTION_HH
#define COLORFEATURE_SUBTRACTION_HH

#include "tree_feature.hh"

namespace Rdfs {

class ColorFeatureSubtraction : public TreeFeature
{
public:
  ColorFeatureSubtraction(int x1=0, int y1=0, int c1=0, int x2=0, int y2=0, int c2=0);
...
BOOST_CLASS_EXPORT_KEY2(Rdfs::ColorFeatureSubtraction, "ColorFeatureSubtraction")

#endif // COLORFEATURE_SUBTRACTION_HH
