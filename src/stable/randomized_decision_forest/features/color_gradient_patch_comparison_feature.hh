#ifndef COLOR_GRADIENT_PATCH_COMPARISON_FEATURE_HH
#define COLOR_GRADIENT_PATCH_COMPARISON_FEATURE_HH
...
class ColorGradientPatchComparisonFeature : public TreeFeature
{
public:
  ColorGradientPatchComparisonFeature(int x1=0, int y1=0, int c1=0, int x2=0, int y2=0, int x3=0, int y3=0, int c2=0, int x4=0, int y4=0, bool scale_with_depth= false);
...
private:
  ...
  bool m_scale_with_depth; /// @brief Set to true in order to scale the patches with the depth.
...
BOOST_CLASS_EXPORT_KEY2(Rdfs::ColorGradientPatchComparisonFeature, "ColorGradientPatchComparisonFeature")


#endif // COLOR_GRADIENT_PATCH_COMPARISON_FEATURE_HH
