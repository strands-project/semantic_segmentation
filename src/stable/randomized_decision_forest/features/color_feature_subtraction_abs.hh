#ifndef COLORFEATURE_SUBTRACTION_ABS_HH
#define COLORFEATURE_SUBTRACTION_ABS_HH

#include "tree_feature.hh"

namespace Rdfs {

class ColorFeatureSubtractionAbs : public TreeFeature
{
public:
  ColorFeatureSubtractionAbs(int x1=0, int y1=0, int c1=0, int x2=0, int y2=0, int c2=0);
...
BOOST_CLASS_EXPORT_KEY2(Rdfs::ColorFeatureSubtractionAbs, "ColorFeatureSubtractionAbs")

#endif // COLORFEATURE_SUBTRACTION_ABS_HH
