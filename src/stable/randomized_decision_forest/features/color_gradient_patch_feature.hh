#ifndef COLOR_GRADIENT_PATCH_FEATURE_HH
#define COLOR_GRADIENT_PATCH_FEATURE_HH
...
class ColorGradientPatchFeature : public TreeFeature
{
public:
  ColorGradientPatchFeature(int x1=0, int y1=0, int c1=0, int x2=0, int y2=0, bool scale_with_depth = false);
...
BOOST_CLASS_EXPORT_KEY2(Rdfs::ColorGradientPatchFeature, "ColorGradientPatchFeature")

#endif // COLOR_GRADIENT_PATCH_FEATURE_HH
